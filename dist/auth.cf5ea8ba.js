...
auth.onAuthStateChanged(function (user) {
  if (user) {
    db.collection('auctions').onSnapshot(function (snapshot) {
...
signupForm.addEventListener('submit', function (ev) {
  ...
  auth.createUserWithEmailAndPassword(email, password).then(function (cred) {// console.log(cred.user);
  });
}); // login existing user

loginForm.addEventListener('click', function (ev) {
  ev.preventDefault();
